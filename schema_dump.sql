...
--
-- Name: delete_session_cascade(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete_session_cascade(p_session_id uuid, p_user_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
CREATE FUNCTION public.validate_api_key(p_raw_key text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_user_id UUID;
...
--
-- Name: FUNCTION validate_api_key(p_raw_key text); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.validate_api_key(p_raw_key text) IS 'Validasi raw API Key. Mengembalikan user_id jika valid, NULL jika tidak.';
...
--
-- Name: TABLE ai_chat_histories; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.ai_chat_histories IS 'Riwayat percakapan AI per kontak, digunakan sebagai konteks multi-turn';


--
-- Name: COLUMN ai_chat_histories.session_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_chat_histories.session_id IS 'FK ke sessions.id';


--
-- Name: COLUMN ai_chat_histories.contact_number; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_chat_histories.contact_number IS 'Nomor WA kontak (format: 6281234567890@c.us)';


--
-- Name: COLUMN ai_chat_histories.messages; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_chat_histories.messages IS 'Array JSON berisi history chat [{role, content}, ...], maksimal 20 pesan terakhir';
...
CREATE TABLE public.ai_configs (
    ...
    ollama_url text DEFAULT 'http://localhost:11434'::text NOT NULL,
    model text DEFAULT 'qwen2.5:7b'::text NOT NULL,
    max_tokens integer DEFAULT 500 NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    fallback_message text DEFAULT 'Maaf, saya sedang tidak bisa memproses pesan Anda saat ini. Tim kami akan segera menghubungi Anda.'::text NOT NULL
);
...
COMMENT ON TABLE public.ai_configs IS 'Konfigurasi AI Auto Reply per sesi WhatsApp';


--
-- Name: COLUMN ai_configs.session_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_configs.session_id IS 'FK ke sessions.id, UNIQUE (1 sesi = 1 konfigurasi AI)';


--
-- Name: COLUMN ai_configs.is_enabled; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_configs.is_enabled IS 'Toggle ON/OFF fitur auto reply AI';


--
-- Name: COLUMN ai_configs.context; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_configs.context IS 'Informasi/konteks bisnis yang diberikan user sebagai system prompt AI';


--
-- Name: COLUMN ai_configs.ollama_url; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_configs.ollama_url IS 'URL Ollama API, default: http://localhost:11434';


--
-- Name: COLUMN ai_configs.model; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_configs.model IS 'Model Ollama yang digunakan, default: qwen2.5:7b';


--
-- Name: COLUMN ai_configs.max_tokens; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.ai_configs.max_tokens IS 'Maksimal token output AI per balasan, default: 500';
...
CREATE TABLE public.api_keys (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    label text DEFAULT 'Default Key'::text NOT NULL,
...
CREATE TABLE public.message_logs (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    source public.message_source DEFAULT 'api'::public.message_source NOT NULL
);
...
--
-- Name: COLUMN message_logs.source; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.message_logs.source IS 'Asal pesan: api (dari REST API), manual (dari dashboard), ai_reply (dari AI chatbot)';
...
--
-- Name: COLUMN profiles.max_sessions; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN sessions.webhook_url; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: session_stats; Type: VIEW; Schema: public; Owner: -
--
...
CREATE VIEW public.session_stats AS
 SELECT s.id AS session_id,
    ...
    count(ml.id) FILTER (WHERE (ml.direction = 'outbound'::public.message_direction)) AS total_sent,
    count(ml.id) FILTER (WHERE (ml.direction = 'inbound'::public.message_direction)) AS total_received,
    count(ml.id) FILTER (WHERE (ml.status = 'failed'::public.message_status)) AS total_failed,
...
--
-- Name: VIEW session_stats; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: ai_configs ai_configs_session_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_configs
    ADD CONSTRAINT ai_configs_session_id_key UNIQUE (session_id);
...
--
-- Name: ai_chat_histories uq_ai_chat_histories_session_contact; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_chat_histories
    ADD CONSTRAINT uq_ai_chat_histories_session_contact UNIQUE (session_id, contact_number);
...
--
-- Name: idx_ai_chat_histories_session_contact; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_chat_histories_session_contact ON public.ai_chat_histories USING btree (session_id, contact_number);


--
-- Name: idx_ai_configs_is_enabled; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_configs_is_enabled ON public.ai_configs USING btree (session_id, is_enabled);


--
-- Name: idx_ai_configs_session_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_configs_session_id ON public.ai_configs USING btree (session_id);
...
--
-- Name: idx_message_logs_session_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_message_logs_session_id ON public.message_logs USING btree (session_id);


--
-- Name: idx_message_logs_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_message_logs_source ON public.message_logs USING btree (source);
...
--
-- Name: idx_message_logs_wa_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_message_logs_wa_id ON public.message_logs USING btree (wa_message_id) WHERE (wa_message_id IS NOT NULL);
...
--
-- Name: idx_webhook_deliveries_log_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_webhook_deliveries_log_id ON public.webhook_deliveries USING btree (message_log_id);
...
--
-- Name: message_logs message_logs_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: ai_chat_histories set_updated_at_ai_chat_histories; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_ai_chat_histories BEFORE UPDATE ON public.ai_chat_histories FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();


--
-- Name: ai_configs set_updated_at_ai_configs; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_ai_configs BEFORE UPDATE ON public.ai_configs FOR EACH ROW EXECUTE FUNCTION public.trigger_set_updated_at();
...
--
-- Name: ai_chat_histories ai_chat_histories_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_chat_histories
    ADD CONSTRAINT ai_chat_histories_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.sessions(id) ON DELETE CASCADE;


--
-- Name: ai_configs ai_configs_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_configs
    ADD CONSTRAINT ai_configs_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.sessions(id) ON DELETE CASCADE;
...
--
-- Name: message_logs message_logs_session_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.message_logs
    ADD CONSTRAINT message_logs_session_id_fkey FOREIGN KEY (session_id) REFERENCES public.sessions(id) ON DELETE CASCADE;
...
--
-- Name: webhook_deliveries webhook_deliveries_message_log_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.webhook_deliveries
    ADD CONSTRAINT webhook_deliveries_message_log_id_fkey FOREIGN KEY (message_log_id) REFERENCES public.message_logs(id) ON DELETE CASCADE;
...
--
-- Name: message_logs Service role can manage message_logs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role can manage message_logs" ON public.message_logs USING ((auth.role() = 'service_role'::text));


--
-- Name: webhook_deliveries Service role can manage webhook_deliveries; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role can manage webhook_deliveries" ON public.webhook_deliveries USING ((auth.role() = 'service_role'::text));


--
-- Name: ai_chat_histories Service role full access ai_chat_histories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Service role full access ai_chat_histories" ON public.ai_chat_histories USING ((auth.role() = 'service_role'::text));
...
CREATE POLICY "Service role full access ai_configs" ON public.ai_configs USING ((auth.role() = 'service_role'::text));
...
--
-- Name: ai_chat_histories Users can delete their own ai_chat_histories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can delete their own ai_chat_histories" ON public.ai_chat_histories FOR DELETE USING ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));


--
-- Name: ai_configs Users can delete their own ai_configs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can delete their own ai_configs" ON public.ai_configs FOR DELETE USING ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));


--
-- Name: api_keys Users can insert own api_keys; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ai_chat_histories Users can insert their own ai_chat_histories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert their own ai_chat_histories" ON public.ai_chat_histories FOR INSERT WITH CHECK ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));


--
-- Name: ai_configs Users can insert their own ai_configs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert their own ai_configs" ON public.ai_configs FOR INSERT WITH CHECK ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));
...
--
-- Name: ai_chat_histories Users can update their own ai_chat_histories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update their own ai_chat_histories" ON public.ai_chat_histories FOR UPDATE USING ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));


--
-- Name: ai_configs Users can update their own ai_configs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update their own ai_configs" ON public.ai_configs FOR UPDATE USING ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));
...
--
-- Name: message_logs Users can view own message_logs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own message_logs" ON public.message_logs FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.sessions s
  WHERE ((s.id = message_logs.session_id) AND (s.user_id = auth.uid())))));
...
--
-- Name: webhook_deliveries Users can view own webhook_deliveries; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own webhook_deliveries" ON public.webhook_deliveries FOR SELECT USING ((EXISTS ( SELECT 1
   FROM (public.message_logs ml
     JOIN public.sessions s ON ((s.id = ml.session_id)))
  WHERE ((ml.id = webhook_deliveries.message_log_id) AND (s.user_id = auth.uid())))));


--
-- Name: ai_chat_histories Users can view their own ai_chat_histories; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own ai_chat_histories" ON public.ai_chat_histories FOR SELECT USING ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));


--
-- Name: ai_configs Users can view their own ai_configs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own ai_configs" ON public.ai_configs FOR SELECT USING ((session_id IN ( SELECT sessions.id
   FROM public.sessions
  WHERE (sessions.user_id = auth.uid()))));


--
-- Name: ai_chat_histories; Type: ROW SECURITY; Schema: public; Owner: -
--
